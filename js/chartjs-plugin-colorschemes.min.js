 ...
 */
! function (f, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e(require("chart.js")) : "function" == typeof define && define.amd ? define(["chart.js"], e) : (f = f || self).ChartColorSchemes = e(f.Chart)
}(this, function (f) {
    "use strict";
    var e = Object.freeze({
        __proto__: null,
        ...
        c = "$colorschemes";
    f.Chart.defaults.plugins.colorschemes = {
    ...
    var a = {
        id: "colorschemes",
        beforeUpdate: function (e, d, a) {
            var b = f.Chart.helpers;
            void 0 === a && (a = d);
            var r, l, o, n, u, t = function (e) {
                var d, c, a, b;
                return Array.isArray(e) ? e : "string" == typeof e && (d = f.Chart.colorschemes || {}, (c = e.match(/^(brewer\.\w+)([1-3])-(\d+)$/)) ? e = c[1] + ["One", "Two", "Three"][c[2] - 1] + c[3] : "office.Office2007-2010-6" === e && (e = "office.OfficeClassic6"), b = d[(a = e.split("."))[0]]) ? b[a[1]] : void 0
            }(a.scheme),
                i = a.fillAlpha,
                s = a.reverse,
                B = a.override,
                G = a.custom;
            t && ("function" == typeof G && (l = G(r = t.slice()), Array.isArray(l) && l.length ? t = l : Array.isArray(r) && r.length && (t = r)), o = t.length, e.config.data.datasets.forEach(function (f, d) {
                switch (n = d % o, u = t[s ? o - n - 1 : n], f[c] = {}, f.type || e.config.type) {
                    case "line":
                    case "radar":
                    case "scatter":
                        (void 0 === f.backgroundColor || B) && (f[c].backgroundColor = f.backgroundColor, f.backgroundColor = b.color(u).alpha(i).rgbString()),
                            (void 0 === f.borderColor || B) && (f[c].borderColor = f.borderColor, f.borderColor = u),
                            (void 0 === f.pointBackgroundColor || B) && (f[c].pointBackgroundColor = f.pointBackgroundColor, f.pointBackgroundColor = b.color(u).alpha(i).rgbString()),
                            (void 0 === f.pointBorderColor || B) && (f[c].pointBorderColor = f.pointBorderColor, f.pointBorderColor = u);
                        break;

                    case "pie":
                    case "polarArea":
                        (void 0 === f.backgroundColor || B) && (f[c].backgroundColor = f.backgroundColor, f.backgroundColor = f.data.map(function (f, e) {
                            return n = e % o, t[s ? o - n - 1 : n]
                        }));
                        break;
                    case "doughnut":
                        (void 0 === f.backgroundColor || B) && (f[c].backgroundColor = f.backgroundColor, f.backgroundColor = f.data.map(function (f, e) {
                            n = e % o;
                            n = t[s ? o - n - 1 : n];
                            return b.color(n).alpha(i).rgbString()
                        })),
                            (void 0 === f.hoverBackgroundColor || B) && (f[c].hoverBackgroundColor = f.hoverBackgroundColor, f.hoverBackgroundColor = f.data.map(function (f, e) {
                                n = e % o;
                                n = t[s ? o - n - 1 : n];
                                return b.color(n).alpha(i * 1.5).rgbString()
                            })),
                            (void 0 === f.borderColor || B) && (f[c].borderColor = f.borderColor, f.borderColor = f.data.map(function (f, e) {
                                return n = e % o, t[s ? o - n - 1 : n]
                            }));
                        break;
                    case "bubble":
                    ...
                    case "bar":
                        (void 0 === f.backgroundColor || B) && (f[c].backgroundColor = f.backgroundColor, f.backgroundColor = b.color(u).alpha(i).rgbString()),
                            (void 0 === f.hoverBackgroundColor || B) && (f[c].hoverBackgroundColor = f.hoverBackgroundColor, f.hoverBackgroundColor = b.color(u).alpha(i * 1.5).rgbString()),
                            (void 0 === f.borderColor || B) && (f[c].borderColor = f.borderColor, f.borderColor = u);
                        break;
                    default:
                        (void 0 === f.backgroundColor || B) && (f[c].backgroundColor = f.backgroundColor, f.backgroundColor = u)
                }
            }))
        },
        afterUpdate: function (f) {
            f.config.data.datasets.forEach(function (f) {
                // f[c] && (f[c].hasOwnProperty("backgroundColor") && (f.backgroundColor = f[c].backgroundColor),
                //     f[c].hasOwnProperty("borderColor") && (f.borderColor = f[c].borderColor),
                // f[c].hasOwnProperty("hoverBackgroundColor") && (f.hoverBackgroundColor = f[c].hoverBackgroundColor),
                // f[c].hasOwnProperty("pointBackgroundColor") && (f.pointBackgroundColor = f[c].pointBackgroundColor),
                // f[c].hasOwnProperty("pointBorderColor") && (f.pointBorderColor = f[c].pointBorderColor),
                // delete f[c])
            })
        },
    ...
    return (f.Chart.register || f.Chart.plugins.register)(a), f.Chart.colorschemes = d, a
});