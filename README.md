...
- **Static** HTML, CSS, JavaScript (no data leaves your browser)
- **PWA** (possible to install on a device)
- **JSON** is generated automatically by a Python script via data mining of game files and [Fields of Mistria Wiki][def_wiki]

## Contact me

GitHub - [HozBlic][def_hozblic]<br />
Reddit - [/u/HozBlic](https://www.reddit.com/user/HozBlic/)
...
[Fields of Mistria][def_fom] assets are covered by [NPC Studio license](https://www.fieldsofmistria.com/eula) <br />
...
[def_wiki]: https://fieldsofmistria.wiki.gg/
